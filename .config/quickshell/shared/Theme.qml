...
QtObject {
    readonly property string fontFamily: "Fira Sans Semibold"
		...
		readonly property color source_color: "#659598"
		...
		readonly property color surface_tint: "#80d4d9"
